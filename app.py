...
def chat(index):
    global rebuttal_segments, accepted_segments, paper_title, paper_content, review_text, deficiency, error_type, rebuttal_action, generated_rebuttal, error_type_done_once, rebuttal_action_done_once
